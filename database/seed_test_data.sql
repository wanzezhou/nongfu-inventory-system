...
-- 说明：商品(products)/库存(inventory) 为真实档案，**不清理、不动**；订单类型 1-送水到府（原「官方平台销售」）2-直营水站销售 3-线下零售 4-量贩机供货 5-水公社 6-零售机供货（旧 5-线下水站返货 已删除，2026-08-25；编号 5 于 2026-09-14 复用为「水公社」）；
--       仅重建 基础信息其他模块 + 订单测试数据。
