...
export const tabGroups = [
  {
    ...
    tabs: [
      ...
      // 手工台账，与其他支出（成本统计组）对称；计入总营收但不属任何订单类型
      { index: '/finance/other-income', title: '其他收入', icon: Coin }
    ]
  },
  {
    key: 'cost',
...
export const menuGroups = [
  ...
  },
  {
    ...
    title: '统计管理',
    icon: TrendCharts,
    items: [{ index: '/statistics/product-sales', title: '商品销售统计', icon: DataLine }]
  },
  {
    type: 'group',
    index: '/fm',
    title: FINANCE_MENU_TITLE,
    icon: Wallet,
    items: FINANCE_ITEMS
  },
